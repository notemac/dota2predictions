...
// Кнопка "Sign in to continue" (welcome.php)
$('.ww-footer, .menu-item-wrapper:last-child').click(function (event) {
...
//     $('.submit-dialog').get(0).showModal();
//     return true;
// })
$('.submit-dialog-close').click(function () {$('.submit-dialog').get(0).close();})
// if ($(".submit-dialog").get(0) != undefined) {
//     $(".submit-dialog").get(0).addEventListener('close', function () {
//         $('.ci-email').val('');
//         $('.ci-subject').val('');
//         $('.ci-message').val('');
//     });
